...
def save_to_csv(data, filename="user_data.csv"):
    fields = [
        ...
        "Вклад в написание исходного текста (%)",
        "И.О. Фамилия (подпись автора)",
        "Должность правообладателя",
        "И.О. Фамилия (подпись правообладателя)",
        "Дата сохранения"
    ]
...
save_to_csv(personal, "resources/out/2.1/user_data.csv")
...
doc.save("resources/out/2.1/Согласие на указание сведений об авторе.docx")